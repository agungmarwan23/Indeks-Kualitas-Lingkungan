...
library(leaflet)
library(BAMMtools)
setwd("D:/2024/Datathon/Pengolahan Data/IKL 2023/")


df <- read_csv("Data_Merge_2023.csv")
dataku <- df[,17:25]
...
colnames(radar_fmsb)
colnames(radar_fmsb) = c("cluster", "AOD_2023mean", "NO2_2023mean", "CO_2023mean", "SO2_2023mean", "NDVI_2023mean", "NTL_2023mean","LST_2023mean", "TSS_2023mean", "IKL_2023mean")
radar_fmsb$cluster = as.character(radar_fmsb$cluster)

max_min <- data.frame(
  AOD_2023mean = c(max(radar_fmsb$AOD_2023mean), min(radar_fmsb$AOD_2023mean)), 
  NO2_2023mean = c(max(radar_fmsb$NO2_2023mean), min(radar_fmsb$NO2_2023mean)),
  CO_2023mean = c(max(radar_fmsb$CO_2023mean), min(radar_fmsb$CO_2023mean)), 
  SO2_2023mean = c(max(radar_fmsb$SO2_2023mean), min(radar_fmsb$SO2_2023mean)), 
  NDVI_2023mean = c(max(radar_fmsb$NDVI_2023mean), min(radar_fmsb$NDVI_2023mean)),
  NTL_2023mean = c(max(radar_fmsb$NTL_2023mean), min(radar_fmsb$NTL_2023mean)), 
  LST_2023mean = c(max(radar_fmsb$LST_2023mean), min(radar_fmsb$LST_2023mean)), 
  TSS_2023mean = c(max(radar_fmsb$TSS_2023mean), min(radar_fmsb$TSS_2023mean)),
  IKL_2023mean = c(max(radar_fmsb$IKL_2023mean), min(radar_fmsb$IKL_2023mean))
)
...
tmap_save(petajabar_tmap, filename = "D:/2024/Datathon/Pengolahan Data/IKL 2023/Visualisasi Hasil Analisis/IKL_2023.png", dpi = 600)
...
st_write(petajabar1, "D:/2024/Datathon/Pengolahan Data/IKL 2023/Visualisasi Hasil Analisis/jabar2023final.shp")
